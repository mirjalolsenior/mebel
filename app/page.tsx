...
import { OmborModule } from "@/components/ombor/ombor-module"
...
import { TovarlarModule } from "@/components/tovarlar/tovarlar-module" // Import TovarlarModule
...
export default function HomePage() {
  ...
  const getPageSubtitle = (tab: string) => {
    switch (tab) {
      case "ombor":
        return "Tovarlar, zapchastlar va kronkalar ombor boshqaruvi"
      case "zakazlar":
        return "Qarzlar boshqaruvi"
      case "mebel":
        return "Kesish bo'limi"
      case "kronka":
