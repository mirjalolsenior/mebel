...
import { Package, ShoppingCart, Sofa, Ribbon, Archive, BarChart3, Settings, Shield, Menu, X, Warehouse } from "lucide-react"
...
const navigationItems = [
  ...
  { id: "zakazlar", label: "Qarz daftari", icon: ShoppingCart },
  { id: "mebel", label: "Kesish", icon: Sofa },
      ...
      <nav className="hidden md:flex items-center justify-center p-6">
        <div className="glass-card rounded-2xl p-2">
          <div className="flex items-center gap-2">
            <Image src="/mebel-sherdor-logo.png" alt="Logo" width={24} height={24} className="w-6 h-6 rounded-md object-cover" />
        ...
        <div className="md:hidden fixed inset-0 z-40 bg-background/80 backdrop-blur-sm">
          <div className="fixed left-4 top-16 bottom-4 w-64 glass-card rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-3 px-2">
              <Image src="/mebel-sherdor-logo.png" alt="Logo" width={24} height={24} className="w-6 h-6 rounded-md object-cover" />
              <span className="text-sm font-semibold">Sherdor Mebel</span>
            </div>
