...
import { ShoppingCart, Plus, Calendar, Search, X } from "lucide-react"
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="relative">
            ...
            <Input
              placeholder="Tovar nomi orqali qidirish..."
              value={searchQuery}
          ...
          ) : zakazlar.filter(z => z.tovar_turi.toLowerCase().includes(searchQuery.toLowerCase())).length === 0 ? (
            <p className="text-muted-foreground text-center py-8">Qidiruvga mos zakazlar topilmadi</p>
          ) : (
            zakazlar
              .filter(z => z.tovar_turi.toLowerCase().includes(searchQuery.toLowerCase()))
              .map((zakaz) => (
